...
export const fishDefinitions: FishDefinition[] = [
  {
    ...
    nameKo: "기본 먹이 물고기",
    nameEn: "Basic Fish",
    assetPath: `${ASSET_BASE}/dot_ocean_small_01_basic_fish.png`,
    level: 1,
    expReward: 10,
    sizeCategory: "small",
    dangerLevel: "safe",
  ...
  },
  {
    ...
    nameKo: "빠른 물고기",
    nameEn: "Fast Fish",
    assetPath: `${ASSET_BASE}/dot_ocean_small_02_fast_fish.png`,
    level: 1,
    expReward: 15,
    sizeCategory: "small",
    dangerLevel: "safe",
  ...
  },
  {
    ...
    nameKo: "무리 물고기",
    nameEn: "School Fish",
    assetPath: `${ASSET_BASE}/dot_ocean_small_03_school_fish.png`,
    level: 2,
    expReward: 20,
    sizeCategory: "small",
    dangerLevel: "safe",
  ...
  },
  {
    ...
    nameKo: "성장 목표 물고기",
    nameEn: "Growth Fish",
    assetPath: `${ASSET_BASE}/dot_ocean_medium_01_growth_fish.png`,
    level: 3,
    expReward: 35,
    sizeCategory: "medium",
    dangerLevel: "neutral",
  ...
  },
  {
    ...
    assetPath: `${ASSET_BASE}/dot_ocean_medium_02_tropical_fish.png`,
    level: 4,
    expReward: 45,
    sizeCategory: "medium",
    dangerLevel: "neutral",
  ...
  },
  {
    ...
    nameKo: "상어",
    nameEn: "Shark",
    assetPath: `${ASSET_BASE}/dot_ocean_large_01_shark.png`,
    level: 8,
    expReward: 120,
    sizeCategory: "large",
    dangerLevel: "danger",
  ...
  },
  {
    ...
    nameKo: "고래",
    nameEn: "Whale",
    assetPath: `${ASSET_BASE}/dot_ocean_large_02_whale.png`,
    level: 12,
    expReward: 200,
    sizeCategory: "large",
    dangerLevel: "danger",
  ...
  },
  {
    ...
    nameKo: "만타가오리",
    nameEn: "Manta Ray",
    assetPath: `${ASSET_BASE}/dot_ocean_large_03_manta_ray.png`,
    level: 7,
    expReward: 100,
    sizeCategory: "large",
    dangerLevel: "neutral",
  ...
  },
  {
    ...
    nameKo: "복어",
    nameEn: "Pufferfish",
    assetPath: `${ASSET_BASE}/dot_ocean_special_01_pufferfish.png`,
    level: 5,
    expReward: 70,
  ...
  },
  {
    ...
    nameKo: "해파리",
    nameEn: "Jellyfish",
    assetPath: `${ASSET_BASE}/dot_ocean_special_02_jellyfish.png`,
    level: 4,
    expReward: 50,
    sizeCategory: "special",
    dangerLevel: "danger",
